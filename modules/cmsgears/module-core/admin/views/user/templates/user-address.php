...
<script id="userAddressTemplate" type="text/x-handlebars-template">
	...
	<div class="info-row clearfix">
		<div class="col col12x2">City</div><div class="col col12x10">{{address.city}}</div>
	</div>
	<div class="info-row clearfix">
		<div class="col col12x2">Country</div><div class="col col12x10">{{address.country}}</div>
	</div>
	<div class="info-row clearfix">
		<div class="col col12x2">State/Province</div><div class="col col12x10">{{address.province}}</div>
	</div>
	<div class="info-row clearfix">
